		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tree Table POC",
									"targetURL": "#artofpossible-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"artofpossible-display": {
								"semanticObject": "artofpossible",
								"action": "display",
								"description": "Tree Table POC",
								"title": "Tree Table POC",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=artofpossible",
									"url": sap.ui.require.toUrl("artofpossible")
								}
							}
						}
					}
